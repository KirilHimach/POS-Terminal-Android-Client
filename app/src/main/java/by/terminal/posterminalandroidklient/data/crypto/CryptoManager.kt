...
import by.terminal.posterminalandroidklient.data.crypto.CryptoConstants.BC_PROVIDER
...
internal object CryptoManager {
    ...
    internal fun encryptSessionKey(sessionKey: ByteArray, publicKey: PublicKey): ByteArray {
        val cipher = Cipher.getInstance(RSA_OAEP_ALGORITHM, BC_PROVIDER)
    ...
    internal fun encryptTlv(data: ByteArray, sessionKey: ByteArray, iv: ByteArray): ByteArray {
        ...
        val cipher = Cipher.getInstance(AES_GSM_ALGORITHM, BC_PROVIDER)
